  ...
  return (
    <>
      ...
      <div className="legal-table-wrap">
        <table className="legal-table">
          ...
          <tbody>
            ...
            <tr>
              <td>JWT; «полезно» / «прочитано» (устройство и, после входа, сервер)</td>
              <td>Сессия и синхронизация вкладок</td>
              <td>Договор (b) для аккаунта; без входа — только устройство (f)</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ul>
        ...
        <li>«Полезные» и «Прочитанные» на аккаунте: 60 и 30 дней.</li>
