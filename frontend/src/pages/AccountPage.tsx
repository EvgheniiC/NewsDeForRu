      ...
      <section className="account-page">
        ...
        <div className="account-form-card account-form-single account-session-card">
          ...
          <p className="muted account-session-note">
            «Полезные» и «Прочитанные» синхронизируются с аккаунтом на всех устройствах. Умная лента и
            голосовое прослушивание — в разработке.
      ...
      {formMode === "register" ? (
        <div className="account-benefits">
          ...
          <ul>
            ...
            <li>
              <strong>Один профиль на всех устройствах</strong> — «Полезные» и «Прочитанные» не привязаны
              только к одному телефону.
            </li>
            <li>
